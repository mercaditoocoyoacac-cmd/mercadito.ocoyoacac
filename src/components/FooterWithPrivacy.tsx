        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4 text-sm text-gray-600">
              <p>
                <strong>Mercadito</strong> respeta tu privacidad. Este aviso explica cómo recopilamos, usamos y protegemos tu información.
              </p>
              ...
              <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                ...
                <p className="mt-1 text-yellow-700 text-xs">
                  Mercadito no se hace responsable por el uso indebido de tu información pública (nombre, dirección, teléfono) por parte de terceros usuarios de la plataforma.
                </p>
              </div>
