...
export default async function PedidoPage({
  ...
  const timelineData = {
    ...
    estimatedDelivery: order.outForDeliveryAt ? formatDateTimeInMexico(new Date(new Date(order.outForDeliveryAt).getTime() + 45 * 60000), { hour: "2-digit", minute: "2-digit" }) : undefined,
    timestamps: {
