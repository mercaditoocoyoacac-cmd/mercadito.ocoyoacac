      ...
      {store.category === "SERVICIOS" ? (
        <div className="mt-8 rounded-xl border border-[var(--border)] bg-[var(--accent-soft)] p-8 text-center">
          ...
          <p className="mt-2 text-sm text-[color:var(--muted)] max-w-md mx-auto">
            {store.name} ofrece servicios por cita. Contáctalos directamente por WhatsApp para agendar tu visita.
          </p>
          {store.address && (
            <div className="mt-4 flex items-center justify-center gap-2 text-sm text-[color:var(--muted)]">
